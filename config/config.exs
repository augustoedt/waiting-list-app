...
config :wait_list, WaitListWeb.Endpoint,
  url: [host: "localhost"],
  render_errors: [
    formats: [html: WaitListWeb.ErrorHTML, json: WaitListWeb.ErrorJSON],
    layout: false
  ],
  pubsub_server: WaitList.PubSub,
  live_view: [signing_salt: "Z67kQjkD"]
...
config :wait_list, WaitList.Mailer, adapter: Swoosh.Adapters.Local
