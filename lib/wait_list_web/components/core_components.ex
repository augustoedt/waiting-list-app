defmodule WaitListWeb.CoreComponents do
  @moduledoc """
  ...
  def flash_group(assigns) do
    ...
    <.flash
      ...
      hidden
    >
      Tentando reconectar <.icon name="hero-arrow-path" class="w-3 h-3 ml-1 animate-spin" />
    </.flash>
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(WaitListWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(WaitListWeb.Gettext, "errors", msg, opts)
    end
  end
